...
const TemperatureIco = props => {
  ...
  <svg width="40" height="109" viewBox="-1 -1 44 113">
        <g id="thermometer">
            ...
            <circle id="Ellipse 25" cx="19.6" cy="88.4" r="10" fill="#FF0000"/>
            <line id="level1" x1="21.6" y1="70.7" x2="29.6" y2="70.7" stroke="black"/>
            <line id="level2" x1="21.6" y1="39.5" x2="29.6" y2="39.5" stroke="black"/>
            <line id="level3" x1="21.6" y1="8.29999" x2="29.6" y2="8.29999" stroke="black"/>

            <rect id="mercury1" x="17.6" y="${
              y1 + count
            }" width="4" height="9.6" fill="${fill1}"/>
            <rect id="mercury2" x="17.6" y="${
              y2 + count
            }" width="4" height="40.8" fill="${fill2}"/>
            <rect id="mercury3" x="17.6" y="${
              y3 + count
            }" width="4" height="72" fill="${fill3}"/>
        </g>
    </svg>
    `;
